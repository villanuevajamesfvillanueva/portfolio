...
const diamonds = `<img src="assets/img/006-diamond.png" alt="diamond">`;
const hearts = `<img src="assets/img/008-heart.png" alt="heart">`;
const spades = `<img src="assets/img/005-spade.png" alt="spade">`;
const clubs = `<img src="assets/img/004-clover.png" alt="club">`;
